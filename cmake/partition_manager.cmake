...
function(set_dfu_hex_offset)
  ...
  if (DEFINED SEC_SLOT_EXT_START)
    if (NOT DEFINED SEC_SLOT_EXT_BASE)
      message(FATAL_ERROR "EXT_BASE must be set when EXT_START is set")
    endif()
    set(ext_offset "${SEC_SLOT_EXT_START} + ${SEC_SLOT_EXT_BASE} +")
  endif()
  ...
  if (CONFIG_NRF53_UPGRADE_NETWORK_CORE
    ...
    set(net_to_sec_sum
      "${ext_offset} ${PM_MCUBOOT_SECONDARY${sec_slot_idx}_ADDRESS} - ${net_app_addr} + ${PM_MCUBOOT_PAD_SIZE}")
  ...
  set(app_to_sec_sum
    "${ext_offset} ${PM_MCUBOOT_SECONDARY_ADDRESS} - ${PM_MCUBOOT_PRIMARY_ADDRESS}")
...
elseif(CONFIG_PM_EXTERNAL_FLASH AND !CONFIG_PM_EXTERNAL_FLASH_SUPPRESS_WRN)
  message(WARNING "\
