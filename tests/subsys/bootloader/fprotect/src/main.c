...
void test_main(void)
{
	ztest_test_suite(test_nsb_fprotect_readback,
			ztest_unit_test(test_flash_write),
			ztest_unit_test(test_flash_read)
			);
	ztest_test_suite(test_nsb_fprotect,
			ztest_unit_test(test_flash_read_protected),
			ztest_unit_test(test_flash_write_protected)
			);
	ztest_run_test_suite(test_nsb_fprotect_readback);
	ztest_run_test_suite(test_nsb_fprotect);
}
