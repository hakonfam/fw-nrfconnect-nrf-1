...
OFFSET_CHECK(struct fw_validation_info, public_key,
	(CONFIG_FW_MAGIC_LEN + 4 + CONFIG_NSB_HASH_LEN));
OFFSET_CHECK(struct fw_validation_info, signature,
	(CONFIG_FW_MAGIC_LEN + 4 + CONFIG_NSB_HASH_LEN
	+ CONFIG_NSB_SIGNATURE_LEN));
