...
if( "${CONFIG_NSB_SIGNING_KEY_FILE}" STREQUAL "")
  ...
  if (NOT EXISTS "${CONFIG_NSB_SIGNING_KEY_FILE}")
    message(FATAL_ERROR "Config points to non-existing PEM file '${CONFIG_NSB_SIGNING_KEY_FILE}'")
  endif()
  set(SIGNATURE_PRIVATE_KEY_FILE ${CONFIG_NSB_SIGNING_KEY_FILE})
endif()

if ("${CONFIG_NSB_PUBLIC_KEY_FILES}" STREQUAL "")
  ...
  set (PUBLIC_KEY_FILES ${CONFIG_NSB_PUBLIC_KEY_FILES})
endif()
