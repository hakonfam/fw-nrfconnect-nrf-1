...
#include <errno.h>
#include <nrf_cc310_nsb_ecdsa_verify_secp256r1.h>
...
{
	CRYSError_t ret;
	nrf_cc310_nsb_ecdsa_verify_context_secp256r1_t context;

	cc310_nsb_backend_enable();
	ret = nrf_cc310_nsb_ecdsa_verify_secp256r1(&context,
			(nrf_cc310_nsb_ecc_public_key_secp256r1_t *) public_key,
			(nrf_cc310_nsb_ecc_signature_secp256r1_t *)  signature,
			hash,
			hash_len
	);
